...
target_names= ["New England","Northern", "North Midland", "South Midland","Southern","New York City","Western","Army Brat (moved around)"]
"""
...
if mode==modes[1]:
    ...
    data_list_path='/scratch/kcprmo/cpc/data/dataset/timit/all_train_timit_english_dilact.pkl'
    data_file_path='/scratch/kcprmo/cpc/data/dataset/timit/all_timit_english_dilact.h5'
    dataset_len=None
    ...
    load_model='/scratch/kcprmo/cpc/CPC/experiments/models/us-tr_CPC_puhelahjat_56705mins_0.001lr_23-Apr_23:56:13-model_best.pth'
    train_ds_model=True
...
if mode==modes[2]:
    ...
    is_model_load_strict=True
    load_model="/scratch/kcprmo/cpc/CPC/experiments/models/ds-ft_DownStreamClassifier_gru_CPC_lpuhelahjat_56705mins_0.001lr_128AW_05-Jun_17:15:02-model_best.pth"
    #load_model=None
    train_ds_model=True
    validate_ds_model=True
    save_model=True
...
if mode==modes[3]:
    ...
    dataset=RawDownStreamDataset
    load_model='/scratch/kcprmo/cpc/CPC/experiments/models/ds-tr_DownStreamClassifier_gru_CPC_puhelahjat_56705mins_0.001lr_128AW_05-Jun_17:31:15-model_best.pth'#original
    data_list_path='/scratch/kcprmo/cpc/data/dataset/timit/all_test_timit_english_dilact.pkl'
    data_file_path='/scratch/kcprmo/cpc/data/dataset/timit/all_timit_english_dilact.h5'
    dataset_len=None
    ds_model_config=[{"in_dim":512,"out_dim":256},{"in_dim":256,"out_dim":124},{"in_dim":124,"out_dim":64}]
    ds_model_no_class=8
