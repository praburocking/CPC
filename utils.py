...
import pandas as pd
def calculate_stats(y_target,y_pred):
    true_positive=None
    true_negative=None
    false_positive=None
    false_negative=None
    ...
    clasifi_report=classification_report(y_target, y_pred, target_names=['neutral', 'sadness', 'joy','anger','tenderness'],output_dict=True)
